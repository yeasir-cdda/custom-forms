                ...
                <Box width={'537px'} mx='auto' height='280px' >
                    <form action="">
                        <SimpleGrid columns={2} spacing='20px' >
                            <Input fontSize={'14px'} color='#737373' lineHeight={'28px'} fontWeight='400' placeholder='Full Name*' />
                            <Input fontSize={'14px'} color='#737373' lineHeight={'28px'} fontWeight='400' placeholder='Email*' />
                            <Select fontSize={'14px'} color='#737373' lineHeight={'28px'} fontWeight='400' placeholder='Please Select'>
                        ...
                        <Textarea mb='40px' mt={'20px'} height='140px' fontSize={'14px'} color='#252B42' lineHeight={'28px'} fontWeight='600' placeholder='Message' />
